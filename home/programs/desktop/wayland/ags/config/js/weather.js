...
const FETCH = `https://api.open-meteo.com/v1/forecast?latitude=${POS[0]}&longitude=${POS[1]}&current=temperature_2m,is_day,rain,showers,snowfall,weathercode,cloudcover&timezone=Europe%2FBerlin&forecast_days=1`
